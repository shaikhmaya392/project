...
const GOLD_BG = rgb(0.984, 0.945, 0.851);
...
export async function buildQuotationPdf(quotation) {
  ...
  const bannerH = 26;
  page.drawRectangle({ x: marginX, y: y - 6, width: 445, height: bannerH, color: GOLD_BG, borderColor: rgb(0.94, 0.86, 0.66), borderWidth: 1 });
  page.drawText(`Quotation valid until ${quotation.valid_until || ""}`, { x: marginX + 12, y: y + 3, size: 10.5, font: bold, color: rgb(0.36, 0.26, 0.03) });
  nl(bannerH + 24);

...
export function quotationEmailHtml(quotation, acceptUrl, baseUrl = "") {
  ...
  <div style="font-family:${font};max-width:560px;margin:0 auto;background:#eef1f7;padding:32px 16px;">
    <div style="background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e4e8f1;box-shadow:0 4px 20px rgba(16,24,40,0.08);">
      ...
      <div style="padding:24px 26px 0;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:14px;">
          <tr>
            ...
            <td style="text-align:right;font-size:11px;font-weight:700;padding:3px 10px;border-radius:999px;background:#fdf1e0;color:#c77706;">Awaiting Response</td>
          </tr>
        </table>
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:16px 26px 0;width:calc(100% - 52px);background:#fbf1d9;border:1px solid #f0dca8;border-radius:10px;">
        <tr>
          <td style="padding:11px 14px;font-size:12.5px;font-weight:600;color:#7a5a10;">
            &#128197; Quotation valid until <strong style="color:#5c4308;">${escapeHtml(quotation.valid_until || "")}</strong>
          </td>
        </tr>
      </table>

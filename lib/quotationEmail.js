            ...
            <table role="presentation" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding-right:14px;">
                  <img src="${logoUrl}" width="70" height="70" alt="DS Permitting Services" style="display:block;width:70px;height:70px;object-fit:contain;border-radius:11px;" />
                </td>
                <td>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding-right:12px;vertical-align:top;">
                  <img src="${logoUrl}" width="70" height="70" alt="" style="display:block;width:70px;height:70px;object-fit:contain;opacity:0.85;" />
                </td>
                <td>

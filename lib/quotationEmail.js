...
export function quotationEmailHtml(quotation, acceptUrl, baseUrl = "", docUploadUrl = null) {
  ...
  <div style="font-family:${font};max-width:600px;margin:0 auto;background:#eef1f7;padding:32px 16px;">
    <div style="background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e4e8f1;box-shadow:0 4px 20px rgba(16,24,40,0.08);">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:26px 30px 0;width:calc(100% - 60px);">
        <tr>
          <td style="width:140px;vertical-align:top;">
            <img src="${logoUrl}" width="130" height="130" alt="DS Permitting Services" style="display:block;width:130px;height:130px;object-fit:contain;" />
          </td>
      ...
      <div style="padding:12px 30px 0;">
        <a href="${docUploadUrl}" style="display:block;text-align:center;background:#ffffff;color:#16296e;text-decoration:none;padding:12px 24px;border-radius:11px;font-weight:700;font-size:13.5px;border:1.5px solid #16296e;">Upload Your Documents</a>
      </div>` : ""}

      ...
      {tab === "Edit" && (
        <form className="card" onSubmit={handleSave}>
          ...
          <div className="form-grid">
            ...
            <div><label>Client Phone</label><input value={project.client_phone || ""} onChange={(e) => onPhoneChange(e, (v) => set("client_phone", v))} placeholder="+1 (123) 456-7890" /></div>
            ...
            <div><label>Homeowner Phone</label><input value={project.homeowner_phone || ""} onChange={(e) => onPhoneChange(e, (v) => set("homeowner_phone", v))} placeholder="+1 (123) 456-7890" /></div>
            ...
            <div className="full"><label>Contractor Phone</label><input value={project.contractor_phone || ""} onChange={(e) => onPhoneChange(e, (v) => set("contractor_phone", v))} placeholder="+1 (123) 456-7890" /></div>
